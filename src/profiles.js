...
// Example generalization: conversation-sealer cares about whether the
// current conversation chain has an unsealed thread that needs a seal or a
// pickup, using the same read-only chain-resume/inbox tools already exposed
// for other profiles -- no new tool-execution surface.
export const CONVERSATION_SEALER_CLASSIFICATION_RULES = Object.freeze([
  Object.freeze({
    id: "seal_or_pickup_current",
    grounding_class: "operational_current",
    domain: "conversation_state",
    intent: "seal_or_pickup_conversation",
    all_of_groups: [
      { any_of: ["seal", "sealed", "sealing", "pickup", "pick up", "resume", "inbox"] },
  ...
  Object.freeze({
    id: "conversation_history_explanation",
    grounding_class: "historical_explanatory",
    domain: "project_memory",
    intent: "historical_explanation",
    all_of_groups: [
      { any_of: ["why", "how", "explain", "reason", "history", "historical"] }
    ],
    reads_template: []
  }),
  FALLBACK_CLASSIFICATION_RULE
...
export const CONVERSATION_SEALER_PROFILE = Object.freeze({
  schema: AGENT_PROFILE_SCHEMA_V1,
  ...
  grounding_policy: {
    grounding_classes_enabled: [...GROUNDING_CLASSES],
    live_read_tools_by_domain: {
      conversation_state: ["cairnstone_resume_chain", "cairnstone_get_inbox"]
    },
    accepted_state_authority: "chain_head_and_path_head",
    historical_evidence_policy: "graph_linked_evidence_only",
    fallback_on_unavailable_live_read: "fail_closed_explicit_degraded",
    citation_provenance: { require_citations: true, prefer_head_linked_evidence: true },
    max_live_read_turns: 4,
    classification_rules: CONVERSATION_SEALER_CLASSIFICATION_RULES
  },
  tool_allowlist: [
    "cairnstone_resume_chain",
...
export const AGENT_PROFILE_REGISTRY = Object.freeze({
  ...
  [CONVERSATION_SEALER_PROFILE.profile_id]: CONVERSATION_SEALER_PROFILE
});
