...
4. Check AC1 correspondence when the client exposes those tools, especially when concurrent work is plausible. Correspondence transports coordination intent but never grants execution authority.
